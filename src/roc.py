...
estima una curva binormal calibrada al AUC real (0.9743) y se superpone el
PUNTO DE OPERACIÓN REAL medido en el test set (umbral 0.56). Se etiqueta
...
def curva_roc_b64():
    ...
    ax.scatter([fpr_real], [tpr_real], color='#ff4d6d', s=70, zorder=5,
               label=f'Umbral 0.56 (TPR {tpr_real:.2f}, FPR {fpr_real:.2f})')
